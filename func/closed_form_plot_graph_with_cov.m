function closed_form_plot_graph_with_cov(g, iteration, H, measurement)
...
% 修改后的图例
legend('Mic. pos. est.','Sigma region of mic. pos. est.','Mic. pos. g. t.','Mic. pos. init.','Sound source g. t.');
...
for i = 1:8
    plot3(measurement((i-1)*3+1), measurement((i-1)*3+2), measurement((i-1)*3+3), 'LineStyle','none','Marker','o', 'MarkerSize', 4,'MarkerEdgeColor','c', 'LineWidth',2);
end
if (length(p) > 0)
    pIdxX = p+1;
    pIdxY = p+2;
